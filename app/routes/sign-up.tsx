...
const copy = {
  en: { title: "Create an account", intro: "Easy Quote is currently available to selected testers.", name: "Name", email: "Email", password: "Password (at least 8 characters)", submit: "Create account", existing: "Already have an account? Sign in", error: "We could not create that account. Check your details and access approval." },
  fr: { title: "Créer un compte", intro: "Easy Quote est actuellement disponible pour des testeurs sélectionnés.", name: "Nom", email: "E-mail", password: "Mot de passe (8 caractères minimum)", submit: "Créer le compte", existing: "Vous avez déjà un compte ? Se connecter", error: "Nous n’avons pas pu créer ce compte. Vérifiez vos informations et votre autorisation d’accès." },
} as const;
