...
export function QuoteHeader({ locale, onLanguage, onList, quote, onRecords, onPrivacy }: {
  ...
  return <header className="qp-app-header">
    ...
    <div className="qp-header-end">
      <Button variant="ghost" size="icon-sm" onClick={onRecords} aria-label={t('Clients et entreprise', 'Customers & business')} title={t('Clients et entreprise', 'Customers & business')}><Settings2 /></Button>
